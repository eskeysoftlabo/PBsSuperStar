...
SafeAddString(SUPERSTAR_VIEWFAV										, "Zeige Fertigkeiten", 1)
SafeAddString(SUPERSTAR_VIEWHASH										, "Zeige Favorit", 1)
...
SafeAddString(SUPERSTAR_RESPEC_INPROGRESS6						, "Allianz Krieg Fertikeitenwurden gesetzt", 1)
